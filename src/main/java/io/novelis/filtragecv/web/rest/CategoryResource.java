...
import io.novelis.filtragecv.service.CategoryService;
...
/**
 * REST controller for managing {@link io.novelis.filtragecv.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    private static final String ENTITY_NAME = "filtragecvCategory";
